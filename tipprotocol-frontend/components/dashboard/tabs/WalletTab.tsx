  ...
  return (
    <div className="space-y-6 sm:space-y-8">
      <div>
        ...
        <p className="text-muted-foreground mt-1">Manage your tokens and balances.</p>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
        <Card className="lg:col-span-2 bg-card border-border">
          <CardHeader>
            <CardTitle className="text-card-foreground text-lg sm:text-xl">Token Balances</CardTitle>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between p-4 border border-border rounded-lg">
                ...
                <div className="text-right">
                  <p className="font-medium text-card-foreground">{Number.parseFloat(usdtBalance).toFixed(2)} USDT</p>
                  <div className="flex flex-col sm:flex-row items-end sm:items-center space-y-1 sm:space-y-0 sm:space-x-2">
                    <span className="text-sm text-muted-foreground">${Number.parseFloat(usdtBalance).toFixed(2)}</span>
        ...
        <div className="space-y-4 sm:space-y-6">
          <Card>
            <CardHeader>
              <CardTitle className="text-card-foreground text-lg sm:text-xl">Deposit USDT</CardTitle>
          ...
          <Card className="bg-card border-border">
            <CardHeader>
              <CardTitle className="text-card-foreground text-lg sm:text-xl">Withdraw USDT</CardTitle>
            ...
            <CardContent className="space-y-4">
              ...
              <Button
                ...
                disabled={
                  ...
                  Number.parseFloat(withdrawAmount) > Number.parseFloat(usdtBalance)
                }
              >
