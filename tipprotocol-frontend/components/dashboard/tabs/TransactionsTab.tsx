// components/dashboard/tabs/TransactionsTab.tsx
"use client";
  ...
  return (
    <div className="space-y-8">
      ...
      <Card className="bg-card border-border">
        <CardHeader>
          <CardTitle className="text-card-foreground">Transaction History (Live Events)</CardTitle>
          <CardDescription>
              ...
              {sortedTransactions.map((tx, index) => (
                ...
                >
                  <div className="flex items-center space-x-4">
                    <div className={`w-10 h-10 rounded-full flex items-center justify-center ${getTransactionBg(tx.type)}`}>
